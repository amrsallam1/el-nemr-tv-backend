...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--bg);color:var(--ink);font-family:Tahoma,"Segoe UI",Arial,sans-serif;font-size:14px}a{color:inherit;text-decoration:none}button,input,select,textarea{font:inherit}
        .shell{display:grid;grid-template-columns:1fr 258px;min-height:100vh}.sidebar{grid-column:2;background:var(--nav);color:#aab2c0;padding:0 14px 28px;position:sticky;top:0;height:100vh;overflow:auto}.brand{height:76px;display:flex;align-items:center;padding:0 10px;color:#fff;font-size:25px;font-weight:900;letter-spacing:.5px;border-bottom:1px solid #24272d}.brand span{color:var(--brand);font-weight:400}.developer{padding:13px 12px 4px;font-size:11px;color:#687180}.nav-section{padding:18px 12px 6px;font-size:10px;font-weight:800;letter-spacing:1.3px;color:#586171}.nav a{display:flex;align-items:center;gap:11px;padding:11px 12px;border-radius:8px;margin:2px 0;transition:.18s}.nav a:hover,.nav a.active{background:#171b20;color:#fff}.nav a.active{box-shadow:inset -3px 0 0 var(--brand)}.nav .icon{width:20px;text-align:center;color:#8b95a5}.nav a.active .icon{color:var(--brand)}
